<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"  version="1.0">
	...
	<html>
        <body>
            ...
            <xsl:if test="section/code/@code = '34070-3'">
...
<!--
            <a href='#' drug='{$drug}' section='#34070-3' class='btn btn-default btn-block lr-hr-moreInfo'><span class="lr-hr-moreInfoIcon"></span>full text</a>
