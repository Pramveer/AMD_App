...
import './compareDrug.html';

var DRUG_LIMIT = 4;

Template.CompareDrug.rendered = function() {
...
function DisplayCompareDrugsData(filterData) {
    ...
    if (filterData && filterData.length > 1) {
        ...
        for (var i = 0; i < filterDrugs.length; i++) {
            ...
            var svgContainer = `<div class="gaugeMeter" style="display: inline-block; margin-top: -12px;" title='Go To Provider Tab for more info'>
            ...
            var compareHtml = '<div class="grid-fix-cell">' +
                ...
                '</div>' +
                //Updated By Jayesh 22th May 2017 For removing safety from provider tab 
                // '<div class="cprsInnerdiv">' +
                // '<div class="cplsLables">&nbsp;</div>' +
