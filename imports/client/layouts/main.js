...
Template.main.destroyed = function() {
    //console.log("main Layout destroyed ");
};
...
Template.main.events({
    ...
    'click .left-side-menu li a': function(e) {
        ...
        if($(e.currentTarget).parent().hasClass('hasSubMenu') && $(e.currentTarget).parent().attr('data-rotate')){
            isHaveSubMenu = true;
        }
    ...
    'click .usermanual-box-load':function(){
